...
image-transform:
	 magick cashew-orig_small-min.png -background none -filter Lanczos -define filter:blur=0.85 -resize 150x150^ -gravity center -extent 150x150 -sharpen 0x0.8 PNG32:cashew.png
